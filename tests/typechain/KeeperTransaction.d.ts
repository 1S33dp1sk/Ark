...
interface KeeperTransactionInterface extends ethers.utils.Interface {
  functions: {
...
export class KeeperTransaction extends BaseContract {
  ...
  interface: KeeperTransactionInterface;
