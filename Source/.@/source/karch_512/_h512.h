...
static const ulong ter_base[3]={0xFFFFFFFF77777777,0x7777777711111111,0x1111111100000000};
...
const char *lfiles[]={"@charms/lbb","@charms/lock","@charms/.lesfile"};
...
char const*__kgev(char *udef_pnop){
