...
typedef struct __contents __ucontent;
#define ucon_len(x) (x.len)
#define ucon_str(x) (x.et)
typedef char __uname[24];
typedef ulong __ul[3];
struct __u_namedcontent {
    __uname uname;
    __ucontent ucon;
    __ul	ukeys;
};
typedef struct __u_namedcontent field;
#define field_name(x) ((char const *)(x.uname))
#define field_content(x) ((char const *)ucon_str(x.ucon))
#define field_length(x) ((ulong)ucon_len(x.ucon))
#define field_keys(x) ((ulong *)(x.ukeys))
typedef field* fld;
typedef fld* fields;
