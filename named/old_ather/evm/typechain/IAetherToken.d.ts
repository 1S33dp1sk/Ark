...
interface IAetherTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class IAetherToken extends BaseContract {
  ...
  interface: IAetherTokenInterface;
