...
interface KeeperAetherInterface extends ethers.utils.Interface {
  functions: {
...
export class KeeperAether extends BaseContract {
  ...
  interface: KeeperAetherInterface;
