...
interface V2AetherHubInterface extends ethers.utils.Interface {
  functions: {
    ...
    "aetheringChains()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "aetheringChains",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class V2AetherHub extends BaseContract {
  ...
  interface: V2AetherHubInterface;
  ...
  functions: {
    ...
    aetheringChains(overrides?: CallOverrides): Promise<[BigNumber[]]>;
    ...
    roll(
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { roll_cid: BigNumber }>;
  ...
  roll(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    aetheringChains(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    roll(overrides?: CallOverrides): Promise<PopulatedTransaction>;
