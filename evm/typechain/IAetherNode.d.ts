...
interface IAetherNodeInterface extends ethers.utils.Interface {
  functions: {
...
export class IAetherNode extends BaseContract {
  ...
  interface: IAetherNodeInterface;
  ...
  callStatic: {
    executeBlock(arg0: BytesLike, overrides?: CallOverrides): Promise<boolean>;
