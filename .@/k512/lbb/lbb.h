...
little black book
...
#ifndef __LBB__H
	#define LBB_FILE "@charms/d.lbb/.lbb"
	...
	#define lbb_fd fld_shard(___shard)
	#define lbb_sze sze_shard(___shard)
	#define lbb_io ioz_shard(___shard)
	#define lbb_path pth_shard(___shard)
