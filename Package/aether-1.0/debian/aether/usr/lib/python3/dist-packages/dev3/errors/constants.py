configuration_errors = {
	1:'Incomplete configurations. Are you sure the `config.json` file is valid?',
...
general_errors = {
	...
	'event_not_found':'Event not defined in the ABI'
}
...
def _getConfErrStr( confErrNo : int ) -> str :
	return configuration_errors.get( confErrNo , 'Configuration Error' )
...
def _getGenErrStr( errName:int ) -> str:
	return general_errors.get( errName , 'GeneralError' )